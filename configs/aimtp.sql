...
--
-- Host: 10.37.91.93    Database: aimtp
-- ------------------------------------------------------
...
--
-- Current Database: `aimtp`
--

/*!40000 DROP DATABASE IF EXISTS `aimtp`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `aimtp` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
