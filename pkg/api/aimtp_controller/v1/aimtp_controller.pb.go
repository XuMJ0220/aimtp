...
var File_aimtp_controller_v1_aimtp_controller_proto protoreflect.FileDescriptor
...
func init() { file_aimtp_controller_v1_aimtp_controller_proto_init() }
func file_aimtp_controller_v1_aimtp_controller_proto_init() {
	if File_aimtp_controller_v1_aimtp_controller_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aimtp_controller_v1_aimtp_controller_proto_rawDesc), len(file_aimtp_controller_v1_aimtp_controller_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_aimtp_controller_v1_aimtp_controller_proto_goTypes,
		DependencyIndexes: file_aimtp_controller_v1_aimtp_controller_proto_depIdxs,
	}.Build()
	File_aimtp_controller_v1_aimtp_controller_proto = out.File
	file_aimtp_controller_v1_aimtp_controller_proto_goTypes = nil
	file_aimtp_controller_v1_aimtp_controller_proto_depIdxs = nil
}
