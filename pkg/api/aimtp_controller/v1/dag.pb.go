...
var file_aimtp_controller_v1_dag_proto_depIdxs = []int32{
	...
	24, // 11: aimtp_controller_v1.Command.args:type_name -> google.protobuf.Struct
	7,  // 12: aimtp_controller_v1.Lifecycle.post_start:type_name -> aimtp_controller_v1.Handler
	7,  // 13: aimtp_controller_v1.Lifecycle.pre_stop:type_name -> aimtp_controller_v1.Handler
	7,  // 14: aimtp_controller_v1.Lifecycle.post_starts:type_name -> aimtp_controller_v1.Handler
	7,  // 15: aimtp_controller_v1.Lifecycle.pre_stops:type_name -> aimtp_controller_v1.Handler
	8,  // 16: aimtp_controller_v1.Handler.exec:type_name -> aimtp_controller_v1.ExecHandler
	9,  // 17: aimtp_controller_v1.Handler.http_get:type_name -> aimtp_controller_v1.HTTPGetHandler
	10, // 18: aimtp_controller_v1.Handler.redis:type_name -> aimtp_controller_v1.RedisHandler
	11, // 19: aimtp_controller_v1.Handler.upload_message:type_name -> aimtp_controller_v1.UploadMessageHandler
	12, // 20: aimtp_controller_v1.Handler.skip_downstream_tasks:type_name -> aimtp_controller_v1.SkipDownstreamTasksHandler
	13, // 21: aimtp_controller_v1.Handler.check_auto_dp_task_done:type_name -> aimtp_controller_v1.CheckAutoDPTaskDoneHandler
	14, // 22: aimtp_controller_v1.Handler.fillback_data_sync:type_name -> aimtp_controller_v1.FillbackDataSync
	24, // 23: aimtp_controller_v1.HTTPGetHandler.headers:type_name -> google.protobuf.Struct
	15, // 24: aimtp_controller_v1.HTTPGetHandler.hook_time_control:type_name -> aimtp_controller_v1.HookTimeControl
	15, // 25: aimtp_controller_v1.RedisHandler.hook_time_control:type_name -> aimtp_controller_v1.HookTimeControl
	19, // 26: aimtp_controller_v1.AsyncTasks.tasks:type_name -> aimtp_controller_v1.AsyncTask
	24, // 27: aimtp_controller_v1.AsyncTask.args:type_name -> google.protobuf.Struct
	1,  // 28: aimtp_controller_v1.CreateDAGRequest.DependenciesEntry.value:type_name -> aimtp_controller_v1.DependenciesList
