...
var file_apiserver_v1_apiserver_proto_depIdxs = []int32{
	...
	1,  // 1: v1.AIMTP.CreateUser:input_type -> v1.CreateUserRequest
	2,  // 2: v1.AIMTP.UpdateUser:input_type -> v1.UpdateUserRequest
	3,  // 3: v1.AIMTP.DeleteUser:input_type -> v1.DeleteUserRequest
	4,  // 4: v1.AIMTP.GetUser:input_type -> v1.GetUserRequest
	5,  // 5: v1.AIMTP.ListUser:input_type -> v1.ListUserRequest
